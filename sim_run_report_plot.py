...
<body data-countdown="{countdown_seconds}">
    <div class="sticky-header">
        <div class="header-top">
            ...
            <div><button class="run-btn" id="runBtn" onclick="runSimulation()">Run Single Simulation</button><span id="status"></span> &nbsp;|&nbsp; <a href="/outputs/sim_outputs_variability.html" style="color:#4fc3f7; text-decoration:none; font-size:0.85em;">View Modelled Variability &rarr;</a></div>
        </div>
