...
<body data-countdown="{countdown_seconds}">
    ...
    <div class="content">
        <div class="summary"><p><strong>Generated:</strong> {run_time_local} <span style="color:#78909c">(run time {display_runtime}s)</span></p><p><strong>Total Unmet Demand:</strong> <span style="color: {'red' if total_unmet > 0 else 'green'}">{total_unmet:,.0f} tons</span></p><p><strong>Status:</strong> Complete &nbsp;|&nbsp; <a href="/outputs/sim_outputs_variability.html" style="color:#4fc3f7; text-decoration:none;">View Variability Distributions &rarr;</a></p></div>
"""
