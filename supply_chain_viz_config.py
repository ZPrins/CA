...
class Config:
    ...
    grid_y_sep: int = 500                       # Vertical distance between Locations (swimlanes)
    grid_pc_sep: int = 1200                     # Extra horizontal separation between Product Class panels (matrix columns)
